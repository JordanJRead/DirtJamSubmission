...
App::App(int screenWidth, int screenHeight, GLFWwindow* window)
	...
	, mTerrainRenderer{ screenWidth, screenHeight, mCamera.getPosition(), 16, 20, ArtisticParamsData{ 22, 50, 0.44, 20, 0.04, 100, 1, 0.2 }, TerrainParamsData{ 15, 28, 0.4, 2 }, {7000, 5000, 5000}, {2, 11, 45}, std::array<glm::vec2, 3> {glm::vec2{0}, glm::vec2{0}, glm::vec2{0}}, 20, 6, 110 }
{
